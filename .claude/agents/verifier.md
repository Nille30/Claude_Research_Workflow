---
name: verifier
description: End-to-end verification agent. Checks that slides compile to PDF and display correctly. Use proactively before committing or creating PRs.
...
- Check that corresponding references in `.tex` files point to existing files

### TikZ Freshness Check (MANDATORY):
**Before verifying any extracted TikZ SVGs:**
