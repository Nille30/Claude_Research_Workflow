---
name: proofread
description: Read-only proofreading pass over Beamer `.tex` slide files. Checks grammar, typos, overflow, terminology consistency, and academic writing quality; produces a report without editing. Use when user says "proofread", "check for typos", "look for grammar issues", "copy-edit this", "any writing errors?", or before a deck release.
...
1. **Identify files to review:**
   ...
   - If `$ARGUMENTS` is "all": review all slide files in `Slides/`
